...
-- best remap ever to copy/paster
...
require('lazy').setup({
      ...
      require('mason-lspconfig').setup {
        ...
        handlers = {
          function(server_name)
            ...
            -- pregnva srngherf bs na YFC (sbe rknzcyr, gheavat bss sbeznggvat sbe gf_yf)
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      -- Set up filetype detection for Blade
      ...
      require('nvim-treesitter.configs').setup {
        ensure_installed = {
          ...
          'markdown',
          'markdown_inline',
          'blade', -- Make sure blade is included here
        },
        sync_install = false,
        auto_install = true,
        highlight = {
